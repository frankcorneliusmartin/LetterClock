...
//boolean digital2, digital3, digital9, digital10, digital11, digital12;        //Create variables as boolean (HIGH or LOW, TRUE or FALSE)
//
//
...
//
//  digital9 = digitalRead(9);       //Reads data from digital port 2 and stores it in the variable "digital2".
//  digital10 = digitalRead(10);       //Reads data from digital port 3 and stores it in the variable "digital3".
//  digital11 = digitalRead(11);       //Reads data from digital port 2 and stores it in the variable "digital2".
//  digital12 = digitalRead(12);       //Reads data from digital port 3 and stores it in the variable "digital3".
...
//  Serial.print("   Digital9: ");   //Prints the text.
//  Serial.println(digital9);        //Prints out the variable "digital3" and ends with a line shift.
//  Serial.print("   Digital10: ");   //Prints the text.
//  Serial.println(digital10);        //Prints out the variable "digital3" and ends with a line shift.
//  Serial.print("   Digital11: ");   //Prints the text.
//  Serial.println(digital11);        //Prints out the variable "digital3" and ends with a line shift.
//  Serial.print("   Digital12: ");   //Prints the text.
//  Serial.println(digital12);        //Prints out the variable "digital3" and ends with a line shift.
//  
